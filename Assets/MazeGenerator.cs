...
public class MazeGenerator : MonoBehaviour
{
    ...
    void SetDestination() {
        ...
        Transform destination = Instantiate(destinationCellPrefab, new Vector3(destinationPosition.x * (int)floorPrefab.localScale.x, 0.5f, destinationPosition.y * (int)floorPrefab.localScale.z), Quaternion.identity);
        destination.parent = transform;
    }

    public void SetPrefabScales() {
